package com.kollu.publisher.config;
...
public class KafkaPublisherConfig {
	...
	public ProducerFactory<String, Object> producerFactory(){
		...
		configs.put(org.apache.kafka.clients.producer.ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, JsonSerializer.class);
	...
	public KafkaTemplate<String, Object> kafkaTemplate(){
		return new KafkaTemplate<>(producerFactory()); //calling above method name
	}
